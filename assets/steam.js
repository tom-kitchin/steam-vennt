...
// Rate limiting tool - 1 concurrent, 250ms gap, queue length limit 20, discard oldest when going over limit, reject promises when dropped.
let requestQueue = new Bottleneck(1, 250, 20, Bottleneck.strategy.LEAK, true)
